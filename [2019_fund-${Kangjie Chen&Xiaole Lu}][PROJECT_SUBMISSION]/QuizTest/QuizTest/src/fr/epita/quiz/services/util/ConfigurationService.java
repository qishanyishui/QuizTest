...
public class ConfigurationService {
    ...
    private static final String defaultConfigFileLocation = "C:\\Users\\dell\\Desktop\\QuizTest\\QuizTest\\src\\conf.properties";
    ...
    private ConfigurationService() {
        // properties loading
        try {
            File confFile = new File(defaultConfigFileLocation);
